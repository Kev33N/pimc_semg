...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/patient_findByPage.action"
		method=post>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>患者姓名：</TD>
													<TD>
														<INPUT class=textbox id=sChannel2 style="WIDTH: 80px" maxLength=50 name="patient_name" value="${model.patient_name}">
													</TD>
													<TD>
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<c:forEach items="${page.beanList }" var="patient">
												<TR
													...
													<%-- <TD>${patient.patient_additional }</TD> --%>
													<TD>
													<a href="${pageContext.request.contextPath }/patient_initDetail?patient_id=${patient.patient_id}">详情</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/patient_initUpdate?patient_id=${patient.patient_id}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/patient_delete?patient_id=${patient.patient_id}" onclick="return window.confirm('确定删除吗？')">删除</a>
													</TD>
												</TR>
