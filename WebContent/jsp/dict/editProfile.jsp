...
<BODY>
	<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/dict_updateProfile.action" method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：系统管理 &gt;<a href="${pageContext.request.contextPath }/dict_findProfileByPage.action">软件配置</a> &gt; 修改软件配置信息</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
