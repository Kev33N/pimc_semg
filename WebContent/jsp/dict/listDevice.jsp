...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/dict_findDeviceByPage.action"
		method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：系统管理 &gt; 采集设备管理</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<td>
														<input class=button type="button" value="增加设备" onclick="location.href='${pageContext.request.contextPath }/dict_initAddNewDeviceUI.action'">
													</td>
												</TR>
											</TBODY>
										</TABLE>
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<c:forEach items="${page.beanList }" var="device">
												<TR
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD>${device.dict_item_name }</TD>
													<TD>${device.dict_item_type }</TD>
													<TD>${device.dict_item_number }</TD>
													<TD>${device.dict_item_samplefrequency }</TD>
													<TD>${device.dict_item_country }</TD>
													<TD>
													<a href="${pageContext.request.contextPath }/dict_initEditDeviceUI.action?dict_id=${device.dict_id}">修改</a>
													&nbsp;&nbsp;
													</TD>
												</TR>
