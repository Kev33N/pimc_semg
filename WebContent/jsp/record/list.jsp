...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/record_findByPage" method="post">
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：试验记录管理 &gt; 实验记录列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/record_initDetail?record_id=${record.record_id}&pageCode=${page.pageCode}">详情</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/record_initUpdate?record_id=${record.record_id}">修改</a>
													&nbsp;&nbsp;
