...
<BODY>
	<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/user_login" method=post target="_top">
			...
			<DIV>
				<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0>
					<TBODY>
										...
										<TR>
											...
											<TD>
												<TABLE cellSpacing=0 cellPadding=2 border=0>
													<TBODY>
														<TR>
															<TD style="HEIGHT: 28px" width=80>登录账号：</TD>
														...
														<TR>
															...
															<td><b style="color:red;">${errorMsg }</b></td>
														</TR>
														<tr><td></td></tr>
														
														<tr>
															<td></td>
															<td><b>没有账号，<a href="${pageContext.request.contextPath }/user_initRegisterUI.action" style="color:red;">立即注册</a></a></b></td>
														</tr>
													</TBODY>
												</TABLE>
											</TD>
						...
						<TR>
							<TD><IMG src="images/login_register_3.jpg" border=0></TD>
						</TR>
					</TBODY>
				</TABLE>
			</DIV>
